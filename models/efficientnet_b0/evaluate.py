...
from models.efficientnet_b0.model import EfficientNetB0VHG
...
def evaluate(config_path="config.yaml", checkpoint="best_model.pth"):
    ...
    logger.info("Evaluando modelo EfficientNet-B0 en test set...")
    ...
    model = EfficientNetB0VHG(num_classes=cfg["model"]["num_classes"], dropout=cfg["model"]["dropout"], pretrained=False)
